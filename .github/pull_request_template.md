...
- [ ] If API contract behavior changed, I updated `packages/ledger-http/openapi/openapi.yaml` in this PR.
...
- [ ] Runtime API behavior in changed code is consistent with `packages/ledger-http/openapi/openapi.yaml`.
